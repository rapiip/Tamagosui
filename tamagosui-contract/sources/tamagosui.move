...
// === Constants ===
const PET_LEVEL_1_IMAGE_URL: vector<u8> = b"https://violet-chemical-hyena-806.mypinata.cloud/ipfs/bafkreifvu35eo5djkqbncqqfw7yihtvhx5tjyueheqhgdle3tynfybkhji";
...
const ACCESSORY_WEAPON_IMAGE_URL: vector<u8> = b"https://violet-chemical-hyena-806.mypinata.cloud/ipfs/bafybeidu5tbjybwokmxxzpdbo5gb2rafwjghjpbqcjnm5rcwk4fj5dhbpe";
...
public entry fun mint_weapon(ctx: &mut TxContext) {
    let accessory = PetAccessory {
        id: object::new(ctx),
        name: string::utf8(b"weapon"),
        image_url: string::utf8(ACCESSORY_WEAPON_IMAGE_URL)
    };
    transfer::public_transfer(accessory, ctx.sender());
}
